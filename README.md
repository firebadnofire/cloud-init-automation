...
* MAC addresses are deterministically generated by VM name
...
I have published my test scripts for [secure-dns-proxy](https://raw.githubusercontent.com/firebadnofire/secure-dns-proxy) in [a Git repo](https://codeberg.org/firebadnofire-init-images/sdp). These scripts use [my secure DNS servers](https://pubhole.archuser.org) but the files are all plaintext and under the MIT license so you may edit them as you wish.
